        ...
        return Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  profile_button('Grid',GridColor),
                  profile_button('List',ListColor1),
                ],
              ),
              SizedBox(
                height: 15,
